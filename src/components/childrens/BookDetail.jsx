...
const BookDetail = () => {
  ...
  <div className="relative">
    <img className="absolute inset-0 w-full h-full object-cover rounded-2xl" src={book.image} alt="Book Cover" />
  </div>
  <div className="flex flex-col justify-between">
    ...
    <div className="flex gap-5 pt-8">
      <Link>
        <button className="btn border-black bg-white text-black px-7">
          Read
        </button>
      </Link>
      <Link>
        <button className="btn secBg text-white px-7">Wishlist</button>
      </Link>
    </div>
  </div>
</div>
